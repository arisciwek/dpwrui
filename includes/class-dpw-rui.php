...
* Changelog:
* 2.1.0
* - Fixed menu initialization to use singleton pattern
* - Updated component loading sequence
* - Added proper dependency handling
* - Fixed constructor access issues
* 
* 2.0.0
...
class DPW_RUI {
   ...
   private function init_components() {
       ...
       // Use singleton pattern for menu
       $this->menu = DPW_RUI_Menu::get_instance($this->plugin_name);
